...
2. Many genetic markers that are not influencing the disease have significant differences in allele frequencies among the population (another correlation); 
