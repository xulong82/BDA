...
####
	...
	temp = data.frame(effect_file$term, effect_file$nnw/127, effect_file$mean.R, i)
...
# shortResults[outcome=="or.BORVAL",][PosteriorExpectedEffect>.1,]
# shortResults[outcome=="or.BORVAL",][PosteriorExpectedEffect< -.1,]

# shortResults[outcome=="os.OSVAL",][PosteriorExpectedEffect>.1,]
# shortResults[outcome=="os.OSVAL",][PosteriorExpectedEffect< -.1,]

# shortResults[outcome=="pfs.PFSVAL",][PosteriorExpectedEffect>.01,]
# shortResults[outcome=="pfs.PFSVAL",][PosteriorExpectedEffect< -.01,]
